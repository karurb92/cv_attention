...
2. split into train-val and create data generator objects (this shit will be tricky because attention model is receiving different data shape than CNN part. this needs to be handled either in models.py or in data_generator.py. I guess models.py is better)
